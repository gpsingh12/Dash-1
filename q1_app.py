...
df1 =  df[['tree_id' ,'health','spc_common', 'borough']] # select columns
...
## check records with missing values are removed
df1.isnull().sum()



## summarize by borough, species and health to get the proportion
...
def update_value(value):
  ...
  #  test =test[test['spc_common']=='value']
    return({'data': [
        {'x': q1_1.borough.unique(), 'y': q1_1.loc[q1_1['spc_common']==value].proportion, 'type': 'bar', 'name': u'Fair'},
        {'x': q1_2.borough.unique(), 'y': q1_2.loc[q1_2['spc_common']==value].proportion, 'type': 'bar', 'name': u'Good'},
        {'x': q1_3.borough.unique(), 'y': q1_3.loc[q1_3['spc_common']==value].proportion, 'type': 'bar', 'name': u'Poor'},
        ],
            'layout': {
